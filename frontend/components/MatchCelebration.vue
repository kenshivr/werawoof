...
<template>
  <!-- Teleport: el <main> del layout app es un stacking context (relative
       z-10) debajo del header y del menú (z-50); desde adentro ningún z-index
       los tapa. En #teleports el overlay sí cubre toda la pantalla.
       overflow-y-auto + my-auto: centrado si entra, scroll si no. -->
  <Teleport to="#teleports">
    <Transition name="celebration">
      <!-- eslint-disable-next-line vue/require-toggle-inside-transition -->
      <div
        class="fixed inset-0 z-[200] flex flex-col items-center overflow-y-auto bg-[#2a1c0e] paw-bg"
      >
        <!-- Fondo oscuro -->
        ...
        <div class="absolute inset-0 pointer-events-none overflow-hidden">
          <span
            class="material-symbols-outlined absolute top-10 left-[12%] text-[#F4C07D]/20 text-7xl -rotate-12 float-icon"
            >pets</span
          >
          <span
            class="material-symbols-outlined absolute bottom-24 left-[8%] text-[#F4C07D]/10 text-9xl rotate-45 float-icon-slow"
            >eco</span
          >
          <span
            class="material-symbols-outlined absolute top-1/4 right-[8%] text-[#F4C07D]/20 text-8xl rotate-12 float-icon"
            style="font-variation-settings: 'FILL' 1"
            >favorite</span
          >
          <span
            class="material-symbols-outlined absolute bottom-1/4 right-[12%] text-[#F4C07D]/15 text-6xl -rotate-6 float-icon-slow"
            >pets</span
          >
          <span
            class="material-symbols-outlined absolute top-1/3 left-[5%] text-[#F4C07D]/10 text-5xl rotate-12 float-icon"
            >star</span
          >
          <span
            class="material-symbols-outlined absolute bottom-1/3 right-[5%] text-[#F4C07D]/10 text-5xl -rotate-12 float-icon-slow"
            style="font-variation-settings: 'FILL' 1"
            >favorite</span
          >
        </div>
        ...
        <!-- Contenido principal -->
        <div
          class="relative z-10 my-auto py-8 flex flex-col items-center text-center px-8 max-w-2xl w-full"
        >
          <!-- Fotos solapadas -->
          <div class="flex items-center justify-center mt-6 mb-6 md:my-10 relative">
            ...
            <!-- Corazón central -->
            <div
              class="absolute z-30 bg-[#F4C07D] w-14 h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-xl heart-bounce"
              style="top: 50%; transform: translateY(-60%)"
            >
              <span
                class="material-symbols-outlined text-[#382615] text-3xl md:text-4xl"
                style="font-variation-settings: 'FILL' 1"
                >favorite</span
              >
            </div>
            ...
            <!-- Otro perro (derecha) -->
            <div
              class="relative w-40 h-40 md:w-56 md:h-56 rounded-full border-4 border-[#F4C07D] shadow-2xl overflow-hidden z-10 dog-card-right"
            >
              <img
                v-if="otherPhoto"
                :src="otherPhoto"
