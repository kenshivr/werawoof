    ...
    <main class="flex-1">
      ...
      <div class="max-w-5xl mx-auto w-full px-6 py-14 flex flex-col gap-14">
        ...
        <section>
          ...
          <div v-if="reviewsStore.loading" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div
              v-for="i in 4"
              :key="i"
              class="bg-white rounded-2xl h-44 animate-pulse shadow-sm"
            />
          </div>
          ...
          <div
            ...
            class="text-center py-20 text-[#4f4539]/90"
          >
            ...
            >
              ...
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-xs text-[#4f4539]/80 mt-0.5">
                    {{
        ...
        <section class="bg-white rounded-2xl shadow-[0_4px_20px_rgba(113,62,24,0.08)] p-8">
          ...
          <p class="text-[#4f4539]/80 text-sm mb-7">
          ...
          <template v-else>
            ...
            <div class="flex flex-col gap-2 mb-6">
              ...
              <div class="flex items-center gap-1">
                ...
                <span
                  v-if="form.rating"
                  class="ml-3 text-sm font-medium text-[#7d571e] font-jakarta"
                >
            ...
            <div class="flex flex-col gap-2 mb-6">
              <div class="flex justify-between items-center">
                <label
                  ...
                  >Tu reseña</label
                >
                <span class="text-xs text-[#4f4539]/80">{{ form.comment.length }} / 300</span>
              </div>
              <textarea
